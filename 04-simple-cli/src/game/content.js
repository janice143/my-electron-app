...
// 选择角色
export const ROLE_CHOSE_MSG = (name) =>
  `角色选择\n${name}可以选择以下角色之一：`;
...
export const ROLE_CHOSE_START_MSG = (roleName) =>
  `${roleName}，惊险刺激的征途开始了，你准备好了吗？`;
...
export const MONSTER_SHOW_MSG = (desc, name, roleName) =>
  `你遇到了${name}，${desc}伟大的${roleName}，你准备战斗还是逃跑`;
